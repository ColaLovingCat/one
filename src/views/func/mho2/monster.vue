...
<template>
    <div class="monster-item">
        <img class="img-egg" v-bind:src="`/docs/mho2/monsters/${monster.index}/egg.png`" alt="">
        <div class="item-name">
            <img class="thumb" v-bind:src="`/docs/mho2/monsters/${monster.index}/thumb.png`" alt="" />
            <div class="name">{{ monster.index }} {{ monster.name }}</div>
            <div class="category">{{ monster.category }}</div>
        </div>
        <div class="item-imgs">
            <img class="img-photo" v-bind:src="`/docs/mho2/monsters/${monster.index}/photo.png`" alt="">
        </div>
            ...
            <div class="item-left">
                ...
                <div class="item-actions">
                    <div class="acton-item" v-for="action in monster.actions">
                        ...
                        <div class="item-type">
                            <img v-bind:src="`/docs/mho2/skills/${action.type}.png`" alt="" srcset="">
                        </div>
                        <i class="fa-solid fa-angles-left"></i>
                        <div class="item-type">
                            <img v-bind:src="`/docs/mho2/skills/${getWeakness(action.type)}.png`" alt="" srcset="">
                        </div>
                    </div>
                </div>
            </div>
